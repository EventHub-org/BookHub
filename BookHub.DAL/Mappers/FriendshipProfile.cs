    ...
    public class FriendshipProfile : Profile
    {
        public FriendshipProfile()
        {
            CreateMap<FriendshipEntity, FriendshipDto>()
                ...
                .ForPath(dest => dest.User2.UserId, opt => opt.MapFrom(src => src.User2.UserId))
